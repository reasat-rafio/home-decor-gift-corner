...
export const ADD_TO_THE_CART = createAction<IProductsProps>(
  "product/ADD_TO_THE_CART"
);
export const PLUS_QUANTITY = createAction<IProductsProps>(
  "product/PLUS_QUANTITY"
);
