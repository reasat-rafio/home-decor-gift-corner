...
export const SHOW_SHOP_CATEGORY_SIDE_MENU = createAction('dom/SHOW_SHOP_CATEGORY_SIDE_MENU')
export const HIDE_SHOP_CATEGORY_SIDE_MENU = createAction('dom/HIDE_SHOP_CATEGORY_SIDE_MENU')
